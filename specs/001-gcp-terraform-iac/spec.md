...
- **FR-004**: Infrastructure code MUST provision a BigQuery dataset to store workout data in the US region
...
- **BigQuery Dataset**: The container for the workout data table. Key attributes: dataset name, location (US).
